...
# 得到初始化模型
alexnetModel = AlexNet(16, 8, 1, optimizer, loss_function, metrics, classes, reg)
...
# 得到模型
train_model = alexnetModel.create_model()
...
result.to_csv('alexnet_submit.csv', index=None)
...
plt.title("Training Loss and Accuracy for AlexNet model.")
plt.xlabel("Epoch #")
plt.ylabel("Loss/Accuracy")
plt.legend()
plt.savefig("alexNet_train_monitor.png")
plt.close()
