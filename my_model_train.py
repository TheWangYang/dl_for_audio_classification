from model.MyModel import Model1
...
# 模型训练
H = train_model.fit(X_train, Y_train, epochs=15, batch_size=8, validation_data=(X_test, Y_test))
...
result.to_csv('mymodel_submit.csv', index=None)
...
plt.title("Training Loss and Accuracy for MyModel.")
plt.xlabel("Epoch #")
plt.ylabel("Loss/Accuracy")
plt.legend()
plt.savefig("MyModel_train_monitor.png")
plt.close()
