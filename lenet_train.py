...
# 得到初始化模型
lenetModel = LeNet(16, 8, 1, optimizer, loss_function, metrics, classes)
...
# 得到模型
train_model = lenetModel.create_model()
...
result.to_csv('lenet_submit.csv', index=None)
...
plt.title("Training Loss and Accuracy for LeNet model.")
plt.xlabel("Epoch #")
plt.ylabel("Loss/Accuracy")
plt.legend()
plt.savefig("LeNet_train_monitor.png")
plt.close()
