...
# 得到初始化模型
minigooglenetModel = MiniGoogLeNet(16, 8, 1, optimizer, loss_function, metrics, classes)
...
# 得到模型
train_model = minigooglenetModel.create_model()
...
result.to_csv('minigooglenet_submit.csv', index=None)
...
plt.title("Training Loss and Accuracy for MiniGoogLeNet model.")
plt.xlabel("Epoch #")
plt.ylabel("Loss/Accuracy")
plt.legend()
plt.savefig("MiniGoogLeNet_train_monitor.png")
plt.close()
