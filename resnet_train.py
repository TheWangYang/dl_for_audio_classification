...
# 得到初始化模型
resnetModel = ResNet(16, 8, 1, optimizer, loss_function, metrics, classes)
...
# 得到模型
train_model = resnetModel.create_model(stages=(9, 9, 9), filters=(64, 64, 128, 256))
...
result.to_csv('resnet_submit.csv', index=None)
...
plt.title("Training Loss and Accuracy for ResNet model.")
plt.xlabel("Epoch #")
plt.ylabel("Loss/Accuracy")
plt.legend()
plt.savefig("ResNet_train_monitor.png")
plt.close()
