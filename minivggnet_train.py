...
# 得到初始化模型
minivggModel = MiniVGGNet(16, 8, 1, optimizer, loss_function, metrics, classes)
...
# 得到模型
train_model = minivggModel.create_model()
...
result.to_csv('minivggnet_submit.csv', index=None)
...
plt.title("Training Loss and Accuracy for MiniVggNet model.")
plt.xlabel("Epoch #")
plt.ylabel("Loss/Accuracy")
plt.legend()
plt.savefig("MiniVggNet_train_monitor.png")
plt.close()
